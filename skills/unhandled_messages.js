module.exports = function(controller) {
    controller.on('message_received', conductOnboarding);
    ...
    controller.hears(['catalogo', 'catálogo'], 'message_received', function(bot, message) {
      ...
      bot.startConversation(message, function(err, convo) {
        ...
        convo.addMessage({
          text: 'Por favor, déjanos tu correo y el producto con el que deseas que se\n\n[Utilice ésta forma para dejar su consulta](https://casacraviotoeshop.com/contacto/)',
        },'contacto');
        convo.addMessage({
          action: 'default'
        }, 'contacto');
